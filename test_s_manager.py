...
#print(percent_diff(S_sigma_im, S_sigma_re), percent_diff(x_sigma_re, S_sigma_re), percent_diff(x_sigma_im, S_sigma_re))
assert percent_diff(S_sigma_im, S_sigma_re) < 0.5 and percent_diff(x_sigma_re, S_sigma_re) < 2 and percent_diff(x_sigma_im, S_sigma_re) < 0.5
